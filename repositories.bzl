...
def build_bazel_rules_nodejs_dependencies():
    ...
    core_sha = "404fb7ee034671eb30cc04c59d217adf0a8bd04b311ece17e052fc7ecb60ac32"
    maybe(
        http_archive,
        name = "rules_nodejs",
        sha256 = core_sha,
...
def build_bazel_rules_nodejs_dev_dependencies():
    ...
    maybe(
        ...
        name = "rules_pkg",
        urls = [
            "https://github.com/bazelbuild/rules_pkg/releases/download/0.7.1/rules_pkg-0.2.6.tar.gz",
