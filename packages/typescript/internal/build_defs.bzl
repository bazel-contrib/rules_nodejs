...
def tsc_wrapped_tsconfig(
    ...
    config = create_tsconfig(
        ...
        node_modules_root = "node_modules", # use node_modules that are linked at the root
        **kwargs
    )
    config["bazelOptions"]["nodeModulesPrefix"] = "node_modules" # use node_modules that are linked at the root
