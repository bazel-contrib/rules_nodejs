...
readonly FOO_JS=$(cat $(rlocation "rules_nodejs/packages/typescript/test/foobar/foo.mjs"))
readonly BAR_JS=$(cat $(rlocation "rules_nodejs/packages/typescript/test/foobar/bar.mjs"))
readonly LIBRARY_JS=$(cat $(rlocation "rules_nodejs/packages/typescript/test/some_library/library.mjs"))
