...
case "${machine}" in
  ...
  darwin) readonly platform_main_manifest="npm/node_modules/vite/bin/vite.js" ;;
  windows) readonly platform_main_manifest="npm/node_modules/vite/bin/vite.js" ;;
  *) readonly platform_main_manifest="npm/node_modules/vite/bin/vite.js" ;;
esac
