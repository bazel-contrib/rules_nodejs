...
load("@build_bazel_rules_nodejs//:providers.bzl", "ExternalNpmPackageInfo", "JSEcmaScriptModuleInfo", "JSModuleInfo", "STAMP_ATTR", "StampSettingInfo", "node_modules_aspect", "run_node")
