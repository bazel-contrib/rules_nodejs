...
load("//:providers.bzl", "declaration_info", "DeclarationInfo", "JSEcmaScriptModuleInfo", "JSModuleInfo", "JSNamedModuleInfo", "LinkablePackageInfo", "NODE_CONTEXT_ATTRS", "NodeContextInfo")
...
def _pkg_npm(ctx):
    ...
    result = [
        ...
        declaration_info(
            declarations = package_dir_depset,
            deps = ctx.attr.deps,
        )
    ]
