  ...
  describe('reduceModules', () => {
    ...
    it('should pull aligned child paths up', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        name: '@foo',
        link: ['execroot', `${BIN_DIR}/root/sub`],
      }];
    ...
    it('should not reduce parent+children aliases aligned to different link types', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        ...
        children: [
          {
            name: '@foo/a/1',
            link: ['runfiles', `${BIN_DIR}/root/sub/a/1`],
          },
        ],
      }];
    ...
    it('should not reduce sibling aliases with different link types', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        ...
        children: [
          ...
          {
            name: '@foo/a/2',
            link: ['execroot', `${BIN_DIR}/root/sub/a/2`],
          },
        ],
      }];
    ...
    it('should not reduce aligned paths when link has extra dir', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        name: '@foo/lib',
        link: ['execroot', `${BIN_DIR}/path/to/lib/noseeme`],
      }];
    ...
    it('should not reduce sibling mappings with inconsistent paths', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        ...
        children: [
          {
            name: '@foo/lib/a',
            link: ['execroot', `${BIN_DIR}/path/to/lib/x`],
          },
          {
            name: '@foo/lib/b',
            link: ['execroot', `${BIN_DIR}/path/to/lib/b`],
          },
        ],
      }];
    ...
    it('should not reduce sibling mappings with inconsistent path parents', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        ...
        children: [
          {
            name: '@foo/lib/a',
            link: ['execroot', `${BIN_DIR}/path/to/lib/x/a`],
          },
          {
            name: '@foo/lib/b',
            link: ['execroot', `${BIN_DIR}/path/to/lib/b`],
    ...
    it('should not reduce to parent mapping with inconcsisten parent link path', () => {
      ...
      const OUT: LinkerTreeElement[] = [{
        name: '@foo/lib',
        link: ['execroot', `${BIN_DIR}/path/to/other/lib`],
        children: [
          {
            name: '@foo/lib/a',
            link: ['execroot', `${BIN_DIR}/path/to/lib/a`],
          },
          {
            name: '@foo/lib/b',
            link: ['execroot', `${BIN_DIR}/path/to/lib/b`],
          ...
          children: [
            {
              ...
              children: [{
                ...
                children: [{
                  name: '@foo/c/c/c/c',
                  link: ['execroot', `${BIN_DIR}/path/to/foo_cccc`],
                }]
              }]
            },
            {
              name: '@foo/d',
              link: ['execroot', `${BIN_DIR}/path/to/foo_d`],
            },
          ],
        },
        {
          name: 'a',
          link: ['execroot', `path/to/lib_a`],
        },
        {
          name: 'b',
          link: ['execroot', 'external/other_wksp/path/to/lib_b'],
