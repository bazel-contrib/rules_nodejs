...
if (process.env[update_var] && process.env['TEST_SRCDIR']) {
  throw new Error(
      `Cannot use ${update_var} when run as a test. Use bazel run instead.`);
}
...
Update the golden file:
      ...
      bazel run --define ${update_var}=${update_val} ${
...
describe('bundling', () => {
  it('should work', () => { check('bundle.min.js', 'bundle-min_golden.js_'); });
