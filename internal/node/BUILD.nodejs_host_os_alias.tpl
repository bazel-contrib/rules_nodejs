...
alias(name = "bin/npm_node_repositories.cmd", actual = "TEMPLATE_npm_node_repositories")
alias(name = "bin/yarn.cmd", actual = "TEMPLATE_yarn")
alias(name = "bin/yarn_node_repositories.cmd", actual = "TEMPLATE_yarn_node_repositories")
...
alias(name = "bin/npm_node_repositories", actual = "TEMPLATE_npm_node_repositories")
alias(name = "bin/yarn", actual = "TEMPLATE_yarn")
alias(name = "bin/yarn_node_repositories", actual = "TEMPLATE_yarn_node_repositories")
...
alias(name = "npm", actual = "TEMPLATE_npm_node_repositories")
alias(name = "yarn", actual = "TEMPLATE_yarn_node_repositories")
