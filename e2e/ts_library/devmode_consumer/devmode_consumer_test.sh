...
readonly LIBRARY_JS=$(cat $(rlocation "e2e_ts_library/some_library/library.js"))
readonly BAR_JS=$(cat $(rlocation "e2e_ts_library/foobar/bar.js"))
readonly FOO_JS=$(cat $(rlocation "e2e_ts_library/foobar/foo.js"))
...
# should produce named UMD modules
if [[ "$BAR_JS" != *"define(\"e2e_ts_library/foobar/bar\""* ]]; then
...
if [[ "$BAR_JS" != *"require(\"e2e_ts_library/foobar/foo\")"* ]]; then
...
if [[ "$BAR_JS" != *"require(\"e2e_ts_library/generated_ts/foo\")"* ]]; then
...
# should produce named UMD modules
if [[ "$FOO_JS" != *"define(\"e2e_ts_library/foobar/foo\""* ]]; then
