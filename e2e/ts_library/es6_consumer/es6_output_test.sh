...
readonly FOO_JS=$(cat $(rlocation "e2e_ts_library/es6_consumer/es6_output.es6/foobar/foo.js"))
readonly BAR_JS=$(cat $(rlocation "e2e_ts_library/es6_consumer/es6_output.es6/foobar/bar.js"))
readonly LIBRARY_JS=$(cat $(rlocation "e2e_ts_library/es6_consumer/es6_output.es6/some_library/library.js"))
