...
2) A [`node_toolchain` rule](https://bazelbuild.github.io/rules_nodejs/Core.html#node_toolchain)
   which depends on your binary defined in step 1 as its `target_tool`.
