...
def rules_nodejs_dev_dependencies():
    ...
    _maybe(
        ...
        patches = [
            "@rules_nodejs//:rules_typescript_pr_494.patch",
            "@rules_nodejs//:rules_typescript_pr_496.patch",
            "@rules_nodejs//:rules_typescript_pr_499.patch",
            "@rules_nodejs//:rules_typescript_pr_508.patch",
        ],
