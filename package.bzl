...
def rules_nodejs_dev_dependencies():
    ...
    _maybe(
        ...
        sha256 = "e568a0dccd6f7e0631ca7cbdb43093c40b52d4c44551c167d9d4101a69897db3",
        strip_prefix = "rules_sass-1.32.0",
        urls = [
            "https://github.com/bazelbuild/rules_sass/archive/1.32.0.zip",
            "https://mirror.bazel.build/github.com/bazelbuild/rules_sass/archive/1.32.0.zip",
        ],
    )
